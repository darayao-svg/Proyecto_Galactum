...
def craftear_recurso(db: Session, jugador_id: int, item_resultado_id: int):
    """
    ...
    recursos_entrada = [
        {"id": linea.item_requerido_id, "quantity": linea.cantidad}
        for linea in lineas_receta
    ]
    
    # Asumimos producción de 1 unidad
    recursos_salida = [{"id": item_resultado_id, "quantity": 1}]
